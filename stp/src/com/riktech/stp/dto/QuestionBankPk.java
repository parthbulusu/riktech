...
/** 
 * This class represents the primary key of the QUESTION_BANK table.
 */
public class QuestionBankPk implements Serializable
{
	 ...
	 * @param id
	 */
	public QuestionBankPk(final long id)
	{
		this.id = id;
	}
	...
	public boolean equals(Object _other)
	{
		...
		if (!(_other instanceof QuestionBankPk)) {
			return false;
		}
		
		final QuestionBankPk _cast = (QuestionBankPk) _other;
		if (id != _cast.id) {
			return false;
		}
	...
	public String toString()
	{
		...
		ret.append( "com.riktech.stp.dto.QuestionBankPk: " );
		ret.append( "id=" + id );
		return ret.toString();
	}
