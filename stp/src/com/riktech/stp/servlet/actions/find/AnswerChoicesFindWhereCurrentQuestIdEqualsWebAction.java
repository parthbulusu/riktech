...
public class AnswerChoicesFindWhereCurrentQuestIdEqualsWebAction extends WebAction
{
	/**
	 * Method 'execute'
	 * 
	...
	public void execute(WebController servlet, HttpServletRequest request, HttpServletResponse response) throws ServletException
	{
		try {
			...
			// execute the finder
			ArrayList<AnswerChoices> list= dao.findWhereCurrentQuestIdEquals(currentQuestId);
		
			// store the results
			request.setAttribute( "result", list );
		
			// forward request on to the appropriate JSP page to display the results
			forward( servlet, request, response, "/find/AnswerChoicesFindWhereCurrentQuestIdEqualsResult.jsp" );
		}
		catch (Exception e) {
